...
Brewer.EstiloCadastroRapido = (function() {
	...
	EstiloCadastroRapido.prototype.iniciar = function() {
		this.form.on('submit', function(event) { event.preventDefault() }); //Ao pressionar enter, não dar o submit
		this.modal.on('shown.bs.modal', onModalShow.bind(this)); //Quando o modal for aberto
		this.modal.on('hide.bs.modal', onModalClose.bind(this)); //Quando o modal é fechado
